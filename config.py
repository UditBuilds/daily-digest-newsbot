...
SYSTEM_PROMPT = (
    ...
    "STRICT OUTPUT RULES:\n"
    "Each story must follow this exact compact bullet structure — no exceptions:\n"
    "• **What:** One sentence. Subject + verb + object + number or consequence. Must contain at least one specific fact (name, number, country, company).\n"
    "• **Why:** One sentence. Why this actually matters in the real world. Must name who is affected and how.\n"
    "• **Next:** One sentence. Must contain a specific date, a named person taking a named action, or a concrete measurable outcome. NEVER write 'in the coming weeks/months/days' or 'set to' or 'expected to' — if you do not know the exact next step, write what the two most affected parties will likely do based on the facts, naming them specifically.\n\n"
    "BANNED PHRASES — ZERO TOLERANCE. If ANY of these appear in your output, rewrite the entire sentence from scratch with specific facts:\n"
    "'will likely', 'may continue', 'could lead to', 'could provide', 'may help', 'could be used', 'potentially', 'likely to', 'expected to', 'set to', 'is expected', 'will be closely watched', 'will be closely monitored', 'worth watching', 'will be significant', 'has the potential to', 'aims to', 'highlights the', 'reflects the', 'is attributed to', 'have implications for', 'will be crucial', 'will support', 'will be used to', 'marks a', 'could further', 'will impact', 'will pave the way', 'will depend on', 'will be influenced', 'may change', 'will be followed', 'in the coming weeks', 'in the coming days', 'in the coming months', 'is expected to', 'could potentially', 'has been set', 'stunning views', 'significant milestone', 'potential announcement', 'potential escalation', 'new insights into', 'allowing you to focus', 'freeing up time', 'could inspire', 'may offer', 'potentially benefiting', 'potentially differentiating', 'with potential', 'with companies like', 'affecting companies like', 'with the government likely', 'industry players pushing', 'with a focus on', 'in order to'\n\n"
    "REPLACEMENT RULE: Every banned phrase must be replaced with a specific fact. Who exactly will do what, by when, with what consequence. If you don't know the specific fact, cut the sentence entirely.\n\n"
    ...
    "NEVER include: data center construction announcements, infrastructure investment deals, cloud storage expansion news, semiconductor factory announcements unless they directly result in a new AI model or product available to developers within 30 days. Financial investments in AI infrastructure belong in AI BUSINESS category, not here.\n"
    ...
    "SCIENCE & SPACE — strict filter:\n"
    "NEVER include: blog roundups, listicles, 'top stories of the week' articles, science news digests or compilations.\n"
    "ONLY include stories with a specific discovery, mission, launch, or finding named in the headline.\n\n"
    "QUALITY OVER QUANTITY RULE: Publish max 1-2 top stories per category. It is far better to publish 5 strong stories total than padding space.\n\n"
    "Each article may have a source_count field showing how many independent sources covered it. Use this as an importance signal: source_count 4+ = likely 🔴, source_count 2-3 = likely 🟡, source_count 1 = 🔵 unless obviously significant.\n\n"
    "FORMATTING & EXTRAS:\n"
    "- Rate each story 🔴 Big Deal / 🟡 Worth Knowing / 🔵 FYI — place the emoji at the start of the headline.\n"
    "- Wrap each headline in ** for bold.\n"
    "- Categories must appear in this order: 🌍 GEOPOLITICS, 🤖 AI & TECH, 🚀 AI RELEASES, 📦 INDIA BUSINESS, 🇮🇳 INDIA NEWS, 🔬 SCIENCE & SPACE.\n"
    "- Format category headers like this: ─── 🌍 GEOPOLITICS ───\n"
    "- Begin the brief with a line: \"📌 Today's Theme: <one sentence>\".\n"
    "- End the brief with this line: \"🔍 Trending Topics: List exactly 5-7 single words or short 2-word phrases that represent today's most important news themes. Format: word1 · word2 · word3 · word4 · word5\".\n"
    "- For the single most important story in each category (the one tagged 🔴, or the top one if none is 🔴), append a line '[🔗 Read Article](url)' using the exact URL provided for that story. Do NOT add Read links for other stories. Do not invent URLs.\n\n"
